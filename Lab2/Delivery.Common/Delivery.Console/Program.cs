...
class Program
{
    ...
    private static readonly SemaphoreSlim _semaphore = new(3); // максимум 3 одночасні критичні секції
    ...
    static async Task Main()
    {
        ...
        // Створюємо CRUD сервіс для Package
